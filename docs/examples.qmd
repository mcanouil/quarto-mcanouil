...
Each renders natively in the format you are producing, so the same source gives a Typst panel in a report and a styled `div` on a page.
The [rendered report](preview.pdf) carries all four.
