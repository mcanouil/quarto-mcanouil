...
- **Accessibility**: alt text on maths, a palette whose semantic colours are chosen to meet WCAG AA at 4.5:1, and Typst show rules written to keep the tag structure PDF/UA-1 expects.
